    ...
    <div className="maindashboard">
      ...
      <div className="dashbox position-relative ">
        <div className="dashwithfav" style={{background:'blue',paddingTop:'1%', paddingButtom:'1%'}}>
          ...
          <span className="my-auto" style={{fontFamily:'Rooboto' ,fontSize: '1.3rem', fontWeight: '400' ,color:'white' }} onClick={() => navigate(-1)} >
        ...
        <br />
        <h6 style={{fontFamily:'Rooboto'}}  className="ms-3 mb-2" style={{ fontFamily: "initial" }}>
          Start Date:-
        </h6>{" "}
        <TextField
